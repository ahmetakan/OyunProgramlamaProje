...
public class TrainRoadCollectableSpawn : MonoBehaviour
{
    public Collectable collectable;
    public float maxSpawnCount = 10;
    float instantiationDelay;
    public List<Collectable> collectables;
    public List<GameObject> trainRoadPath;
    void Start()
    {
    ...
    void spawnCollectable()
    {
        ...
        var randomValue = Random.Range(0,trainRoadPath.Count);



        Collectable _collectable = Instantiate(collectable, null);

        _collectable.transform.position = trainRoadPath[randomValue].transform.position;
